...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (move_uploaded_file($image_tmp, $image_path)) {
        $query = "INSERT INTO jobs (title, description, duration, requirement, fee, image) 
                  VALUES ('$title', '$description', '$duration', '$requirement', '$fee', '$image_path')";
        if (mysqli_query($conn, $query)) {
            $msg = "<div class='alert alert-success'>✅ Job added successfully!</div>";
        } else {
            $msg = "<div class='alert alert-danger'>❌ Failed to insert into database.</div>";
        }
    } else {
        $msg = "<div class='alert alert-warning'>⚠️ Failed to upload image.</div>";
    }
}
?>
